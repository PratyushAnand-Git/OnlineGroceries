    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                ...
                LineSecureField( title: "New Password", placholder: "Enter a new password", txt: $forgotVM.txtNewPassword, isShowPassword: $forgotVM.isNewPassword)
                    .padding(.bottom, .screenWidth * 0.02)
                
                LineSecureField( title: "Confirm Password", placholder: "Renter new password", txt: $forgotVM.txtConfirmPassword, isShowPassword: $forgotVM.isConfirmPassword)
